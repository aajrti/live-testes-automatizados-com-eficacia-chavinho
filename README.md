...
- :white_check_mark: usar o `Builder` pattern para definir configurações da classe `Chavinho` como se tem cabeçalho ou não e o separador
...
- :white_check_mark: limitar a JVM de execução do código para 128 MB com `-Xmx 128m` e tratar o seguinte CSV de 311 MB: https://drive.google.com/uc?id=18BLAZDeH74Ll3b4GsMNY3s-YVnNmWblC&export=download  
